...
const deployedContracts = {
  11155111: {
    DEX: {
      address: "0xb260a88af65d4e13074d5e936f9ec1c328728d08",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 11696862,
    },
    MyUSD: {
      address: "0x9fd56b9c83c870a842f19c6ce3aebb45571f2f43",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 11696861,
    },
    MyUSDEngine: {
      address: "0x69bba10c2fb04ced6331322d95e0d9e920f7a64d",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 11696866,
    },
    MyUSDStaking: {
      address: "0x250f3a77e5fd014dc798807a857245659b2e27d3",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 11696864,
    },
    Oracle: {
      address: "0x79220a49c683ab425bf2eb11a34fb9a7ebbb54dd",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 11696863,
    },
    RateController: {
      address: "0x7ed42cb47a0c0563ca407769ffbe01a7be29750e",
      abi: [
        {
          inputs: [
            {
